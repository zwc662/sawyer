...
### ROS-Intera 
1. After entering interactive model of the container, follow the steps in the [tutorial](https://support.rethinkrobotics.com/support/solutions/articles/80000980136)

> Example: Interact with robot
```
python 
